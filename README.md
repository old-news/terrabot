...
# Current phase
Right now, I am working on making a CNN that can read an image of a block and output what block that is.

# Todo
Use ffts to find the pixel offset of an image on screen.
Implement the AI with a simple break-block command.
